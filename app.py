...
sales_monitor_page = st.Page("streamlit_pages/prediction.py", title="Forecasts", icon=":material/finance_mode:")
...
pg = st.navigation({"Welcome to SweetPulse!":[sales_monitor_page, build_your_own_page, analytics_page, diagnostics_total_page, diagnostics_item_A_page, diagnostics_item_B_page,
